...
## 코드 수정 및 승인 정책 & 검증 규칙
- **API 호출 테스트 절대 금지**: Gemini API, Pexels/Pixabay API, YouTube API 등 실제 외부 유료/할당량 소모 API를 호출하는 로컬 테스트를 절대 실행하지 마십시오. 문법 검사(`python -m py_compile`) 및 오프라인 Mock 검증만 수행해야 합니다.
